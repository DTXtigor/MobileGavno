...
public class MeshDestroy : MonoBehaviour
{
    ...
    {
        var orMesh = GetComponent<MeshFilter>();
        if (!orMesh) orMesh = GetComponentInChildren<MeshFilter>();
        var originalMesh = orMesh.mesh;
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            var mesh = new Mesh();
            var fil = original.GetComponent<MeshFilter>();
            if (!fil) original.GetComponentInChildren<MeshFilter>();
            mesh.name = fil.mesh.name;
            ...
            if (!rend) rend = original.GetComponentInChildren<MeshRenderer>();

            renderer.materials = rend.materials;
            if(original._shader)renderer.material.shader = original._shader;
            ...
            var inf = GameObject.AddComponent<FadeAndDestroy>();
